...
# Upstream path: src/core/utils/win32/aumid.py
...
from vendor.win32.constants import PROCESS_QUERY_LIMITED_INFORMATION, TH32CS_SNAPPROCESS
from vendor.win32.structs import PROCESSENTRY32
...
def activate_app_by_aumid(aumid: str, fallback_process_name: str | None = None) -> bool:
    ...
    """
    from vendor.win32.window_actions import force_foreground_focus, restore_window
