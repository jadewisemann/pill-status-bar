...
# Upstream path: src/core/utils/win32/pe_icons.py
...
from vendor.win32.constants import LOAD_LIBRARY_AS_DATAFILE, LOAD_LIBRARY_AS_IMAGE_RESOURCE, RT_GROUP_ICON, RT_ICON
