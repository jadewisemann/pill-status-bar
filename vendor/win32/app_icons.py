...
# Upstream path: src/core/utils/win32/app_icons.py
...
from vendor.win32.aumid import GetApplicationUserModelId, get_aumid_for_window
from vendor.win32.aumid_icons import get_icon_for_aumid
from vendor.win32.bindings import (
    CloseHandle,
    DeleteObject,
    GetDC,
    GetDIBits,
...
from vendor.win32.constants import PROCESS_QUERY_LIMITED_INFORMATION, SHGSI_ICON, SHGSI_LARGEICON
from vendor.win32.pe_icons import IconExtractor
from vendor.win32.structs import BITMAP, BITMAPINFO, BITMAPINFOHEADER, ICONINFO, SHSTOCKICONINFO
