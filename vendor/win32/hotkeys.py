...
# Upstream path: src/core/utils/win32/hotkeys.py
...
from vendor.win32.bindings import user32
from vendor.win32.bindings.kernel32 import GetCurrentThreadId
...
class HotkeyListener(QThread):
    ...
    def _emit_binding(self, binding: HotkeyBinding) -> None:
        ...
        from vendor.win32.utils import find_focused_screen
