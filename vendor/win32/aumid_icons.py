...
# Upstream path: src/core/utils/win32/aumid_icons.py
...
from vendor.win32.aumid import GUID, _ensure_com_initialized
...
from vendor.win32.structs import BITMAP, BITMAPINFO, BITMAPINFOHEADER
